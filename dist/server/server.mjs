...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-CA8J7kAV.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    component: () => import("./_nuxt/login-Bgsvk73l.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-myffncU4.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Dpq37Hnu.js").then((r) => r.default || r));
