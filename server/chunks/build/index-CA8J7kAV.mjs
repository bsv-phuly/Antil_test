...
import { useSSRContext, defineComponent, mergeProps, unref, withCtx, createTextVNode, createVNode, renderSlot, computed } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot } from 'vue/server-renderer';
import { toast, Toaster } from 'vue-sonner';
import { Primitive, useForwardPropsEmits, SelectRoot, SelectValue, useForwardProps, SelectTrigger, SelectIcon, SelectPortal, SelectContent, SelectViewport, SelectGroup, SelectItem, SelectItemIndicator, SelectItemText, SelectLabel, SelectScrollUpButton, SelectScrollDownButton } from 'radix-vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "" }, _attrs))}><h1 class="text-3xl font-bold underline"> Hello world! </h1>`);
      ...
      _push(ssrRenderComponent(unref(_sfc_main$9), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$7), { class: "w-[180px]" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$8), { placeholder: "Select a fruit" }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(unref(_sfc_main$8), { placeholder: "Select a fruit" })
                  ];
                }
              }),
              _: 1
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$5), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$4), { value: "apple" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(` Apple `);
                            } else {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$4), { value: "banana" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(` Banana `);
                            } else {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$4), { value: "blueberry" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(` Blueberry `);
                            } else {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$4), { value: "grapes" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(` Grapes `);
                            } else {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$4), { value: "pineapple" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(` Pineapple `);
                            } else {
                        ...
                        return [
                          ...
                          createVNode(unref(_sfc_main$4), { value: "apple" }, {
                            default: withCtx(() => [
                              createTextVNode(" Apple ")
                            ]),
                            _: 1
                          }),
                          createVNode(unref(_sfc_main$4), { value: "banana" }, {
                            default: withCtx(() => [
                              createTextVNode(" Banana ")
                            ]),
                            _: 1
                          }),
                          createVNode(unref(_sfc_main$4), { value: "blueberry" }, {
                            default: withCtx(() => [
                              createTextVNode(" Blueberry ")
                            ]),
                            _: 1
                          }),
                          createVNode(unref(_sfc_main$4), { value: "grapes" }, {
                            default: withCtx(() => [
                              createTextVNode(" Grapes ")
                            ]),
                            _: 1
                          }),
                          createVNode(unref(_sfc_main$4), { value: "pineapple" }, {
                            default: withCtx(() => [
                              createTextVNode(" Pineapple ")
                            ]),
                            _: 1
...
//# sourceMappingURL=index-CA8J7kAV.mjs.map
